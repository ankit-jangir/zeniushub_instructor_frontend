...
import { getUpcomingEmis, downloadEmiExcel } from "../Redux/Api/Accounts_api"; // Add downloadEmiExcel
      ...
      <SidebarInset>
        ...
        <main className="flex-1 p-4 sm:p-6 bg-gray-50 dark:bg-gray-900">
              ...
              <Button
                ...
                onClick={() => {
                  const params = {
                    ...
                    status: "missed", // Set to "missed" for this component
                    courseId: selectedCourseId || "",
                    batchId: selectedBatchId || "",
                  };
            ...
            <div className="flex gap-3">
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button
                    variant="outline"
                    className="flex items-center gap-2 border-gray-300 dark:border-gray-600 w-full sm:w-auto"
                  >
                    {selectedCourse}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 mb-6 
                ...
                >
                  ...
                  <div className="grid gap-4 py-4">
                    <div className="grid grid-cols-1 sm:grid-cols-4 items-center gap-4">
                      <Label className="sm:text-right">FROM :</Label>
                      <Button
                        variant="outline"
                        className="w-full flex items-center text-left justify-between border border-blue-400 rounded-xl px-4 py-2 shadow-sm font-normal"
                        onClick={(e) => {
                          e.preventDefault();
                          fromInputRef.current?.showPicker();
                        }}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-4 items-center gap-4">
                      <Label className="sm:text-right">TO :</Label>
                      <Button
                        variant="outline"
                        className="w-full flex items-center text-left justify-between border border-blue-400 rounded-xl px-4 py-2 shadow-sm font-normal"
                        onClick={(e) => {
            ...
            {/* Export Excel */}
            <div className="flex items-center justify-start xl:justify-center w-full">
              <Button
                className="w-full sm:w-auto bg-blue-600 text-white hover:bg-blue-700"
                onClick={() => {
                  const params = {
          ...
          <div className="bg-white dark:bg-gray-900 shadow-xl rounded-xl border border-gray-200 dark:border-gray-700">
            <div className="overflow-x-scroll w-full sm:w-[630px] lg:w-full">
              {loading ? (
                    ...
                    {emis.map((row, index) => {
                      ...
                      return (
                        <tr
                          ...
                          onClick={() => handleRowClick(row.Student_Enrollment?.student_id)}
                        >
                          ...
                          {/* <td className="p-4 border-b font-semibold text-red-600 dark:text-red-400">
                            {typeof row.due_amount === 'number' ? `₹${row.due_amount.toLocaleString()}` : "N/A"}
                          </td> */}
                        </tr>
                      );
                    })}
